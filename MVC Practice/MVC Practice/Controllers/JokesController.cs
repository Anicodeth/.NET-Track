...
namespace MVC_Practice.Controllers
{
    public class JokesController : Controller
    {
        ...
        public JokesController(ApplicationDbContextContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Joke != null ? 
                          ...
                          Problem("Entity set 'ApplicationDbContextContext.Joke'  is null.");
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,JokeQuestions,JokeAnswers")] Joke joke)
        {
            if (id != joke.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ApplicationDbContextContext.Joke'  is null.");
            }
            var joke = await _context.Joke.FindAsync(id);
            if (joke != null)
            {
